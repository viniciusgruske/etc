...
SVGMapElement.prototype.updateLabel = function() {
	...
	if (this.options.label !== null) {
		var element = this.map.layers.elements.add('textarea', {
			...
			** + style: 'text-shadow: 0px 0px 2px #FFF, 0px 0px 2px #FFF, 0px 0px 4px #FFF, 0px 0px 4px #FFF, 0px 0px 6px #FFF, 0px 0px 6px #FFF, 0px 0px 8px #FFF, 0px 0px 8px #FFF, 0px 0px 10px #FFF, 0px 0px 10px #FFF',
			*/
			style: 'text-shadow: 0px 0px 2px #FFF, 0px 0px 2px #FFF, 0px 0px 4px #FFF, 0px 0px 4px #FFF, 0px 0px 6px #FFF, 0px 0px 6px #FFF, 0px 0px 8px #FFF, 0px 0px 8px #FFF, 0px 0px 10px #FFF, 0px 0px 10px #FFF',
			background: {
